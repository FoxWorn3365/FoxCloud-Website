...
$plugins->addEventListener($url);
   ...
   <h3><code>$plugins->addEventListener($url);</code></h3>
   Questa stringa avvia il caricamento di tutti i plugin.<br>
  </a>
...
$plugins->loadPlugin([PLUGIN-NAME]);  // Esempio: $plugins->loadPlugin('betterCloud.phar');
  ...
  <a id='plugins-new'>
   ...
   <a id='plugins-new-mappa-file'>
    ...
    <pre>
 - main.php     -> File principale, include gli altri e basta
 - funzione_1.php -> altro file
 - funzione_2.php -> altro file
 - config.json    -> Configurazione che definisce le principali caratteristiche di un plugin.
    </pre>
    <h4><code>main.php</code></h4>
    Questo file deve semplicemente includere tutti gli altri file del progetto.<br>
    Consigliamo vivamente di non metterci il codice se non i <code>require_once</code> necessari.<br>
    Lascio un esempio del file:<br>
    <pre>
&lt;?php
require_once("funzione_1.php");
require_once("funzione_2.php");
    </pre>
    <br><br>
    <h4><code>funzione_1.php</code> e <code>funzione_2.php</code></h4>
    ...
    <pre>
{
   ...
   "name":"Test",
   "project_namespace":"FoxWorn3365/FoxCloudPlugin/Test",
   "description":"Questo plugin è di test, niente di particolare :(",
   "version":"0.2",
   "enable":true,
   "load":"after",
   "loadEverywhere":false,
   "phpVersion":"7.4",
   "cloud_version":"1.5",
   "compatibility":{
      "cloudVersions":[
   ...
   "type":"phar_plugin"
    ...
    <h4><code>enable</code></h4>
    <b>Type:</b> <code>boolean</code><br>
    <b>Nullable:</b> <u>NO</u><br>
    Indica se il plugin deve essere caricato oppure no.<br><br>
    <h4><code>load</code></h4>
    <b>Type:</b> <code>string</code> - <code>pre / after</code><br>
    <b>Nullable:</b> <u>NO</u><br>
    Indica se il plugin deve essere caricato prima o dopo la pagina.<br><br>
    <h4><code>loadEverywhere</code></h4>
    <b>Type:</b> <code>boolean</code><br>
    <b>Nullable:</b> <u>NO</u><br>
    Indica se il plugin non deve essere caricato solo in qualche URL.<br><br>
    <h4><code>phpVersion</code></h4>
    <b>Type:</b> <code>string</code><br>
    <b>Nullable:</b> <u>NO</u><br>
    Indica la versione di PHP designata per il plugin.<br><br>
    <h4><code>cloud_version</code></h4>
    <b>Type:</b> <code>string</code><br>
    <b>Nullable:</b> <u>NO</u><br>
    Indica la versione di FoxCloud per cui è stato designato il plugin.<br><br>
    ...
    <h4><code>compatibility->defaultVersion</code></h4>
    <b>Type:</b> <code>string</code><br>
    <b>Nullable:</b> <u>NO</u><br>
    Indica la versione preferibile di FoxCloud per il plugin.<br><br>
    <h4><code>dieFiNotCompatible</code></h4>
    <b>Type:</b> <code>boolean</code><br>
    <b>Nullable:</b> <u>NO</u><br>
    Indica se il plugin deve auto-disabilitarsi se la versione non è supportata.<br><br>
    <h4><code>URLs</code></h4>
    <b>Type:</b> <code>ARRAY</code><br>
    <b>Nullable:</b> <u>NO</u><br>
    Indica la lista di URL che triggerano il plugin se il parametro <code>loadEverywhere</code> è <code>false</code>.<br><br>
